...
<?php
if(htmlspecialchars(!isset($_SESSION["email"])) and htmlspecialchars(!isset($_COOKIE["email"])))
{
    if ($x=function($e){return str_replace(array('\\'), '/', $e);}) if(in_array( $x("header.php"), array_map( $x ,  get_included_files() ) ) )
    {
        echo("Hello, already included !");
    }else
    include ("header.php")
